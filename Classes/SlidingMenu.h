...
public:
	...
	virtual bool init();
	virtual void onExit();
    static SlidingMenuGrid* create(CCArray *items, int cols, int rows, CCPoint pos , CCPoint pad);
    static SlidingMenuGrid* create(CCArray *items, int cols, int rows, CCPoint pos , CCPoint pad, bool vertical);
